...
return [
    ...
    */
    ...
    'confirmed'            => 'A confirmação de O campo :attribute não confere.',
    ...
    'not_in'               => 'O O campo :attribute selecionado é inválido.',
    'numeric'              => 'O campo :attribute deve ser um número.',
    'present'              => 'O O campo :attribute deve estar presente.',
    'regex'                => 'O formato de O campo :attribute é inválido.',
    'required'             => 'O campo O campo :attribute é obrigatório.',
    'required_if'          => 'O campo O campo :attribute é obrigatório quando :other é :value.',
    'required_unless'      => 'O O campo :attribute é necessário a menos que :other esteja em :values.',
    'required_with'        => 'O campo O campo :attribute é obrigatório quando :values está presente.',
    'required_with_all'    => 'O campo O campo :attribute é obrigatório quando :values estão presentes.',
    'required_without'     => 'O campo O campo :attribute é obrigatório quando :values não está presente.',
    'required_without_all' => 'O campo O campo :attribute é obrigatório quando nenhum destes estão presentes: :values.',
    ...
    'url'                  => 'O formato de O campo :attribute é inválido.',
